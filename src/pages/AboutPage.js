    ...
    <div className="h-screen w-screen bg-gray-100">
      ...
      <div className="block md:flex">
        <div className="body-section md:w-1/3">
          <div className="">
            <img alt="tailwind" className="mx-auto shadow bg-gray-300 rounded-full w-32 h-32" src={tailwind} />
            <div className="mt-4 mx-auto text-center">Made with Tailwind CSS</div>
          </div>
        </div>
        <div className="body-section md:w-1/3">
          <div className="">
            <img alt="react" className="mx-auto shadow bg-gray-300 rounded-full w-32 h-32" src={react} />
            <div className="mt-4 mx-auto text-center">Made with React</div>
          </div>
        </div>
        <div className="body-section md:w-1/3">
          <div className="">
            <div className="mx-auto shadow bg-gray-300 rounded-full w-32 h-32"><img alt="postgres" className="w-16 m-auto pt-8" src={postgres} /></div>
